...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		...
		if (!empty($banner_info)) {
			$data['zone_type'] = $banner_info['zone_type'];
		}

		$this->load->model("catalog/category");
		if (!empty($banner_info)) {
			if($banner_info['zone_type'] == "category"){
				$data['zone_id'] = $banner_info['zone_id'];
				$data['category_info'] = $this->model_catalog_category->getCategory($banner_info['zone_id']);
			}elseif($banner_info['zone_type'] == "all_page"){
				$data['zone_id'] = $banner_info['zone_id'];
			}
		}
