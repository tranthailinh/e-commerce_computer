...
class ModelDesignBanner extends Model {
	public function addBanner($data) {
		if($data['position'] == 'category'){
			$zone_type = "category";
			$zone_id = $data['category_id'];
		}else{
			$zone_type = "all_page";
			$zone_id = $data['position'];
		}

		$this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "', zone_type = '" . $zone_type . "', zone_id = '" . $zone_id . "'");
	...
	public function editBanner($banner_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "', zone_type = '" . $zone_type . "', zone_id = '" . $zone_id . "' WHERE banner_id = '" . (int)$banner_id . "'");
