      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <?php if(isset($tab_group_product)){ ?>
            <!--Group product-->
            <li><a href="#tab-gp" data-toggle="tab"><?php echo $tab_group_product; ?></a></li>
            <!--End group product-->
            <?php } ?>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-short-description<?php echo $language['language_id']; ?>">Mô tả ngắn</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][short_description]" placeholder="<?php echo $entry_description; ?>" id="input-short-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Sản phẩm hotdeal:</label>
                    <div class="col-sm-10">
                      <?php if($is_hotdeal == 1){ ?>
                      <label class="radio-inline"><input type="radio" name="hotdeal" value="1" checked="checked"> Có</label>
                      <label class="radio-inline"><input type="radio" name="hotdeal" value="0"> Không</label>
                      <?php }else{ ?>
                      <label class="radio-inline"><input type="radio" name="hotdeal" value="1" > Có</label>
                      <label class="radio-inline"><input type="radio" name="hotdeal" value="0" checked="checked"> Không</label>
                      <?php } ?>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Sản phẩm highlight:</label>
                    <div class="col-sm-10">
                      <?php if($is_highlight == 1){ ?>
                      <label class="radio-inline"><input type="radio" name="highlight" value="1" checked="checked"> Có</label>
                      <label class="radio-inline"><input type="radio" name="highlight" value="0"> Không</label>
                      <?php }else{ ?>
                      <label class="radio-inline"><input type="radio" name="highlight" value="1" > Có</label>
                      <label class="radio-inline"><input type="radio" name="highlight" value="0" checked="checked"> Không</label>
                      <?php } ?>
                    </div>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-gp">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr class="info">
                    <td class="text-left col-md-3"><strong>Options</strong></td>
                    <td class="text-left"><strong>Childs</strong></td>
                  </tr>
                  </thead>
                  <tbody id="gp-rows">
                    <?php foreach($products_gp as $key => $product_gp){ ?>
                    <tr id="gp-row-<?php echo $key; ?>">
                      <td class="text-left">
                        <div class="form-group">
                          <div class="col-sm-10">
                            <input type="text" name="gp[<?php echo $key; ?>][option_name]" value="<?php echo $product_gp['option_name']; ?>" data-toggle="tooltip" title="Name" class="form-control">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-10">
                            <div class="input-group">
                              ...
                              <select name="gp[<?php echo $key; ?>][option_required]" data-toggle="tooltip" title="Option Required" class="form-control">
                                <?php if($product_gp['option_required'] == 1){ ?>
                        ...
                        <div class="form-group">
                          <div class="col-sm-10"><div class="input-group">
                              ...
                              <input type="number" name="gp[<?php echo $key; ?>][option_sort_order]" value="0" data-toggle="tooltip" title="Sort Order" class="form-control">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td class="text-left" style="vertical-align:top;">
                        <div class="table-responsive">
                          <table class="table table-hover">
                            <thead>
                            <tr>
                              <td class="text-left text-nowrap">ID</td>
                              <td class="text-left text-nowrap">Tên sản phẩm</td>
                              <td class="text-left text-nowrap">Model</td>
                              <td class="text-left text-nowrap">Giá</td>
                              <td class="text-left text-nowrap" style="width:1px;">Sắp xếp</td>
                              <td class="text-left text-nowrap"></td>
                            </tr>
                            </thead>
                            <tbody id="gp-row-childs-<?php echo $key; ?>">
                              <?php if(count($product_gp['child']) > 0){ ?>
                                <?php foreach($product_gp['child'] as $key1 => $child_cf_product){ ?>
                                 <tr id="gp-row-child-<?php echo $key1; ?>-<?php echo $child_cf_product['product_id']; ?>">
                                    <td class="text-left"><?php echo $child_cf_product['product_id']; ?></td>
                                    <td class="text-left"><?php echo $child_cf_product['info']['name']; ?></td>
                                    <td class="text-left"><?php echo $child_cf_product['info']['model']; ?></td>
                                    <td class="text-left"><?php echo $child_cf_product['info']['price']; ?></td>
                                    <td class="text-left">
                                      <input type="text" name="gp[<?php echo $key; ?>][child][<?php echo $child_cf_product['product_id']; ?>][child_sort_order]" value="<?php echo $child_cf_product['child_sort_order']; ?>" class="form-control" />
                                    </td>
                                    <td class="text-left">
                                      <button type="button" onclick="$(this).tooltip('destroy'); $('#gp-row-child-<?php echo $key1; ?>-<?php echo $child_cf_product["product_id"]; ?>').remove();" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                                    </td>
                                  </tr>
                                <?php } ?>
                              <?php } ?>
                            ...
                            <tr>
                              <td></td>
                              <td><input type="text" data-gp-row="<?php echo $key; ?>" onkeyup="gpAddChild($(this), 'name');" value="" class="form-control"></td>
                              <td></td>
                              <td></td>
                              <td></td>
                              <td></td>
                  ...
                  <tfoot>
                  <tr>
                    <td class="text-right" colspan="2"><button type="button" onclick="addGPOption();" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add GP Option"><i class="fa fa-plus-circle"></i></button></td>
                  </tr>
                  </tfoot>
                </table>
              </div>
            ...
            <?php
            if(isset($products_gp)){
              echo "var gp_row = " . count($products_gp) . ";";
            }else{
              echo "var gp_row = 0;";
            }
            ?>

            function addGPOption() {
              html  = '<tr id="gp-row-' + gp_row + '">';

              // Options
              html += '  <td class="text-left">';

              html += '    <div class="form-group"><div class="col-sm-10">';
              html += '        <input type="text" name="gp[' + gp_row + '][option_name]" value="" data-toggle="tooltip" title="Name" class="form-control" />';
              html += '    </div></div>';

              html += '    <div class="form-group"><div class="col-sm-10">';
              html += '      <div class="input-group">';
              html += '        <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>';
              html += '        <select name="gp[' + gp_row + '][option_required]" data-toggle="tooltip" title="Option Required" class="form-control" >';
              html += '          <option value="1">Yes</option>';
              html += '          <option value="0">No</option>';
              html += '        </select>';
              html += '        <span class="input-group-addon"><i class="fa fa-th-list"></i></span>';
              html += '      </div>';
              html += '    </div></div>';

              html += '    <div class="form-group"><div class="col-sm-10"><div class="input-group">';
              html += '      <span class="input-group-addon"><i class="fa fa-sort"></i></span>';
              html += '      <input type="number" name="gp[' + gp_row + '][option_sort_order]" value="0" data-toggle="tooltip" title="Sort Order" class="form-control" />';
              html += '    </div></div></div>';
              ...
              html += '      <thead>';
              html += '        <tr>';
              html += '          <td class="text-left text-nowrap">ID</td>';
              html += '          <td class="text-left text-nowrap">Tên sản phẩm</td>';
              html += '          <td class="text-left text-nowrap">Model</td>';
              html += '          <td class="text-left text-nowrap">Giá</td>';
              html += '          <td class="text-left text-nowrap" style="width:1px;">Sắp xếp</td>';
              html += '          <td class="text-left text-nowrap"></td>';
              html += '        </tr>';
              html += '      </thead>';
              html += '      <tbody id="gp-row-childs-' + gp_row + '">';
              html += '      </tbody>';
              html += '      <tfoot>';
              html += '        <tr>';
              html += '          <td></td>';
              html += '          <td><input type="text" data-gp-row="' + gp_row + '" onkeyup="gpAddChild($(this), \'name\');" value="" class="form-control" /></td>';
              html += '          <td></td>';
              html += '          <td></td>';
              html += '          <td></td>';
              html += '          <td></td>';
            ...
            function gpAddChild(theInput, theFilter) {
              theRow = theInput.attr('data-gp-row');
              theInput.autocomplete({
                ...
                'select': function(item) {
                  $('input[data-gp-row="' + theRow + '"]').val('');
                  $('#gp-row-child-' + theRow + '-' + item['value']).remove();

                  html  = '<tr id="gp-row-child-' + theRow + '-' + item['value'] + '">';
                  ...
                  html += '  <td class="text-left">';
                  html += '    <input type="text" name="gp[' + theRow + '][child][' + item['value'] + '][child_sort_order]" class="form-control" />';
                  html += '  </td>';
                  html += '  <td class="text-left">';
                  html += '    <button type="button" onclick="$(\'#gp-row-child-' + theRow + '-' + item['value'] + '\').remove();" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>';
                  html += '  </td>';
                  html += '</tr>';

                  $('#gp-row-childs-' + theRow).append(html);
                }
              });
            }
            </script>
