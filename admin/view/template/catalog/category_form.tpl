      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-gp" data-toggle="tab">Danh mục sản phẩm cấu hình</a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-gp">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-gp-in-category">Danh mục cấu hình</label>
                <div class="col-sm-5">
                  <select name="gp_in_category" id="input-gp-in-category" class="form-control">
                    <option value="0" >Disabled</option>
                    <option value="1" <?php if($gp_in_category == 1){ echo "selected"; } ?>>Enabled</option>
                  </select>
                </div>
              </div>
            </div>
