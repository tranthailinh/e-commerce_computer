...
//				$customer_info = $this->model_account_customer->getCustomer($this->customer->getId());
			...
			$order_data['payment_postcode'] = '1000';
			$order_data['payment_zone'] = '';
			$order_data['payment_zone_id'] = $this->session->data['shipping_address']['zone_id'];
			$order_data['payment_country'] = 'VN';
			$order_data['payment_country_id'] = $this->session->data['shipping_address']['country_id'];
			$order_data['payment_address_format'] = '';
			$order_data['payment_custom_field'] = (isset($this->session->data['shipping_address']['custom_field']) ? $this->session->data['payment_address']['custom_field'] : array());
...
//			}
			...
			$order_data['payment_method'] = 'Thanh toán khi nhận hàng';
...
//			}
			...
			if ($this->cart->hasShipping()) {
				...
				$order_data['shipping_postcode'] = '1000';
				$order_data['shipping_zone'] = '';
				$order_data['shipping_zone_id'] = $this->session->data['shipping_address']['zone_id'];
				$order_data['shipping_country'] = 'VN';
			...
			$order_data['comment'] = $this->session->data['shipping_address']['comment'];
